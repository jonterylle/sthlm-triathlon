...
const URL_ERRORS: Record<string, string> = {
  inte_inbjuden: "Din e-postadress är inte inbjuden. Kontakta tävlingsledningen för att få en inbjudan.",
  auth_failed: "Inloggningslänken är ogiltig eller har gått ut. Begär en ny länk.",
  missing_code: "Något gick fel med inloggningslänken. Försök igen.",
};
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
      {status === "sent" ? (
        ...
        <>
          <h2 className="text-lg font-semibold text-brand-dark mb-1">Logga in</h2>
...
// ── Sida — wrapping LoginForm i Suspense (krävs av Next.js för useSearchParams) ──
