-- ============================================================
-- Migration 023: Fri text (beskrivning) på funktionärsuppdrag
-- ============================================================

ALTER TABLE public.pass
  ADD COLUMN IF NOT EXISTS beskrivning text;

-- Uppdatera get_pass_med_sektioner — lägger till beskrivning
...
-- Uppdatera get_min_sektion_data (SL-vy) — lägger till beskrivning
