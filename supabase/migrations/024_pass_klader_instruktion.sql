-- ============================================================
-- Migration 024: Ersätt generisk beskrivning med två strukturerade fält
--   klader_utrustning — vad funktionären ska ha på sig/ta med
--   instruktion       — vad funktionären ska göra
-- beskrivning-kolumnen behålls men används inte längre i UI:t.
-- ============================================================

ALTER TABLE public.pass
  ADD COLUMN IF NOT EXISTS klader_utrustning text,
  ADD COLUMN IF NOT EXISTS instruktion       text;

-- Uppdatera get_pass_med_sektioner — byt ut beskrivning mot de två nya
